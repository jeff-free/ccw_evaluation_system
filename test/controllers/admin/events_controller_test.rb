...
class Admin::EventsControllerTest < ActionController::TestCase
  ...
  test "should create admin_event" do
    assert_difference('Admin::Event.count') do
      post :create, admin_event: { evaluation_id: @admin_event.evaluation_id, interpellation_id: @admin_event.interpellation_id, name: @admin_event.name }
    end
  ...
  test "should update admin_event" do
    patch :update, id: @admin_event, admin_event: { evaluation_id: @admin_event.evaluation_id, interpellation_id: @admin_event.interpellation_id, name: @admin_event.name }
    assert_redirected_to admin_event_path(assigns(:admin_event))
  end
